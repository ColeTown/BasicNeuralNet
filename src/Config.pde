...
public final int numberOfParentAgentsPerGen = 30;
public final int carRadius = 10;
public final float maxTurn = PI/45;
public float timePerGeneration = 60; //in seconds
public final int numberOfCarsShown = 100;
public float mutationFactor = .5;
